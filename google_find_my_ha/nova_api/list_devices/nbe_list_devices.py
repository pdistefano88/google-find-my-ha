...
from google_find_my_ha.nova_api.scopes import NOVA_LIST_DEVICS_API_SCOPE
...
def create_device_list_request() -> str:
    wrapper = device_update_pb2.DevicesListRequest()

    # Query for Spot devices
    wrapper.deviceListRequestPayload.type = device_update_pb2.DeviceType.SPOT_DEVICE
