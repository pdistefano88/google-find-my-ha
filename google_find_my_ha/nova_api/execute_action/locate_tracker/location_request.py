...
from google_find_my_ha.nova_api.execute_action.nbe_execute_action import create_action_request, serialize_action_request
from google_find_my_ha.nova_api.nova_request import nova_request
from google_find_my_ha.nova_api.scopes import NOVA_ACTION_API_SCOPE
...
from google_find_my_ha.proto_decoders.decoder import parse_device_update_protobuf
...
def create_location_request(canonic_device_id: str,
    ...
    action_request.action.locateTracker.contributorType = device_update_pb2.SpotContributorType.FMDN_ALL_LOCATIONS
