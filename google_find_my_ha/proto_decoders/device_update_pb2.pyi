from google_find_my_ha.proto_decoders import common_pb2 as _common_pb2
...
class GetEidInfoForE2eeDevicesResponse(_message.Message):
    ...
    def __init__(self, encryptedOwnerKeyAndMetadata: _Optional[
        _Union[EncryptedOwnerKeyAndMetadata, _Mapping]] = ...) -> None: ...
...
class EncryptedOwnerKeyAndMetadata(_message.Message):
    ...
    def __init__(self, encryptedOwnerKey: _Optional[bytes] = ..., ownerKeyVersion: _Optional[int] = ...,
                 securityDomain: _Optional[str] = ...) -> None: ...
...
class DevicesListRequest(_message.Message):
    ...
    def __init__(self,
                 deviceListRequestPayload: _Optional[_Union[DevicesListRequestPayload, _Mapping]] = ...) -> None: ...
...
class ExecuteActionRequest(_message.Message):
    ...
    def __init__(self, scope: _Optional[_Union[ExecuteActionScope, _Mapping]] = ...,
                 action: _Optional[_Union[ExecuteActionType, _Mapping]] = ...,
                 requestMetadata: _Optional[_Union[ExecuteActionRequestMetadata, _Mapping]] = ...) -> None: ...
...
class ExecuteActionRequestMetadata(_message.Message):
    ...
    def __init__(self, type: _Optional[_Union[DeviceType, str]] = ..., requestUuid: _Optional[str] = ...,
                 fmdClientUuid: _Optional[str] = ...,
                 gcmRegistrationId: _Optional[_Union[GcmCloudMessagingIdProtobuf, _Mapping]] = ...,
                 unknown: bool = ...) -> None: ...
...
class ExecuteActionType(_message.Message):
    ...
    def __init__(self, locateTracker: _Optional[_Union[ExecuteActionLocateTrackerType, _Mapping]] = ...,
                 startSound: _Optional[_Union[ExecuteActionSoundType, _Mapping]] = ...,
                 stopSound: _Optional[_Union[ExecuteActionSoundType, _Mapping]] = ...) -> None: ...
...
class ExecuteActionLocateTrackerType(_message.Message):
    ...
    def __init__(self, lastHighTrafficEnablingTime: _Optional[_Union[_common_pb2.Time, _Mapping]] = ...,
                 contributorType: _Optional[_Union[SpotContributorType, str]] = ...) -> None: ...
...
class ExecuteActionScope(_message.Message):
    ...
    def __init__(self, type: _Optional[_Union[DeviceType, str]] = ...,
                 device: _Optional[_Union[ExecuteActionDeviceIdentifier, _Mapping]] = ...) -> None: ...
...
class DeviceUpdate(_message.Message):
    ...
    def __init__(self, fcmMetadata: _Optional[_Union[ExecuteActionRequestMetadata, _Mapping]] = ...,
                 deviceMetadata: _Optional[_Union[DeviceMetadata, _Mapping]] = ...,
                 requestMetadata: _Optional[_Union[RequestMetadata, _Mapping]] = ...) -> None: ...
...
class DeviceMetadata(_message.Message):
    ...
    def __init__(self, identifierInformation: _Optional[_Union[IdentitfierInformation, _Mapping]] = ...,
                 information: _Optional[_Union[DeviceInformation, _Mapping]] = ...,
                 userDefinedDeviceName: _Optional[str] = ...,
                 imageInformation: _Optional[_Union[ImageInformation, _Mapping]] = ...) -> None: ...
...
class IdentitfierInformation(_message.Message):
    ...
    def __init__(self, phoneInformation: _Optional[_Union[PhoneInformation, _Mapping]] = ...,
                 type: _Optional[_Union[IdentifierInformationType, str]] = ...,
                 canonicIds: _Optional[_Union[CanonicIds, _Mapping]] = ...) -> None: ...
...
class DeviceInformation(_message.Message):
    ...
    def __init__(self, deviceRegistration: _Optional[_Union[DeviceRegistration, _Mapping]] = ...,
                 locationInformation: _Optional[_Union[LocationInformation, _Mapping]] = ...,
                 accessInformation: _Optional[_Iterable[_Union[AccessInformation, _Mapping]]] = ...) -> None: ...
...
class DeviceRegistration(_message.Message):
    __slots__ = ("deviceTypeInformation", "encryptedUserSecrets", "manufacturer", "fastPairModelId", "pairDate",
                 "model")
    ...
    def __init__(self, deviceTypeInformation: _Optional[_Union[DeviceTypeInformation, _Mapping]] = ...,
                 encryptedUserSecrets: _Optional[_Union[EncryptedUserSecrets, _Mapping]] = ...,
                 manufacturer: _Optional[str] = ..., fastPairModelId: _Optional[str] = ...,
                 pairDate: _Optional[int] = ..., model: _Optional[str] = ...) -> None: ...


class EncryptedUserSecrets(_message.Message):
    __slots__ = ("encryptedIdentityKey", "ownerKeyVersion", "encryptedAccountKey", "creationDate",
    ...
    def __init__(self, encryptedIdentityKey: _Optional[bytes] = ..., ownerKeyVersion: _Optional[int] = ...,
                 encryptedAccountKey: _Optional[bytes] = ...,
                 creationDate: _Optional[_Union[_common_pb2.Time, _Mapping]] = ...,
                 encryptedSha256AccountKeyPublicAddress: _Optional[bytes] = ...) -> None: ...
...
class LocationsAndTimestampsWrapper(_message.Message):
    ...
    def __init__(self, recentLocationAndNetworkLocations: _Optional[
        _Union[RecentLocationAndNetworkLocations, _Mapping]] = ...) -> None: ...


class RecentLocationAndNetworkLocations(_message.Message):
    __slots__ = ("recentLocation", "recentLocationTimestamp", "networkLocations", "networkLocationTimestamps",
    ...
    def __init__(self, recentLocation: _Optional[_Union[_common_pb2.LocationReport, _Mapping]] = ...,
                 recentLocationTimestamp: _Optional[_Union[_common_pb2.Time, _Mapping]] = ...,
                 networkLocations: _Optional[_Iterable[_Union[_common_pb2.LocationReport, _Mapping]]] = ...,
                 networkLocationTimestamps: _Optional[_Iterable[_Union[_common_pb2.Time, _Mapping]]] = ...,
                 minLocationsNeededForAggregation: _Optional[int] = ...) -> None: ...
...
class AccessInformation(_message.Message):
    ...
    def __init__(self, email: _Optional[str] = ..., hasAccess: bool = ..., isOwner: bool = ...,
                 thisAccount: bool = ...) -> None: ...
...
class EncryptionUnlockRequestExtras(_message.Message):
    ...
    def __init__(self, operation: _Optional[int] = ...,
...
class Location(_message.Message):
    ...
    def __init__(self, latitude: _Optional[int] = ..., longitude: _Optional[int] = ...,
                 altitude: _Optional[int] = ...) -> None: ...


class RegisterBleDeviceRequest(_message.Message):
    __slots__ = ("fastPairModelId", "description", "capabilities", "e2eePublicKeyRegistration", "manufacturerName",
                 "ringKey", "recoveryKey", "unwantedTrackingKey", "modelName")
    FASTPAIRMODELID_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, fastPairModelId: _Optional[str] = ...,
                 description: _Optional[_Union[DeviceDescription, _Mapping]] = ...,
                 capabilities: _Optional[_Union[DeviceCapabilities, _Mapping]] = ...,
                 e2eePublicKeyRegistration: _Optional[_Union[E2EEPublicKeyRegistration, _Mapping]] = ...,
                 manufacturerName: _Optional[str] = ..., ringKey: _Optional[bytes] = ...,
                 recoveryKey: _Optional[bytes] = ..., unwantedTrackingKey: _Optional[bytes] = ...,
                 modelName: _Optional[str] = ...) -> None: ...
...
class E2EEPublicKeyRegistration(_message.Message):
    ...
    def __init__(self, rotationExponent: _Optional[int] = ...,
                 encryptedUserSecrets: _Optional[_Union[EncryptedUserSecrets, _Mapping]] = ...,
                 publicKeyIdList: _Optional[_Union[PublicKeyIdList, _Mapping]] = ...,
                 pairingDate: _Optional[int] = ...) -> None: ...
...
class PublicKeyIdList(_message.Message):
    ...
    class PublicKeyIdInfo(_message.Message):
        ...
        def __init__(self, timestamp: _Optional[_Union[_common_pb2.Time, _Mapping]] = ...,
                     publicKeyId: _Optional[_Union[TruncatedEID, _Mapping]] = ...,
                     trackableComponent: _Optional[int] = ...) -> None: ...
    ...
    def __init__(self, publicKeyIdInfo: _Optional[
        _Iterable[_Union[PublicKeyIdList.PublicKeyIdInfo, _Mapping]]] = ...) -> None: ...
...
class UploadPrecomputedPublicKeyIdsRequest(_message.Message):
    ...
    class DevicePublicKeyIds(_message.Message):
        ...
        def __init__(self, canonicId: _Optional[_Union[CanonicId, _Mapping]] = ...,
                     clientList: _Optional[_Union[PublicKeyIdList, _Mapping]] = ...,
                     pairDate: _Optional[int] = ...) -> None: ...
    ...
    def __init__(self, deviceEids: _Optional[
        _Iterable[_Union[UploadPrecomputedPublicKeyIdsRequest.DevicePublicKeyIds, _Mapping]]] = ...) -> None: ...
...
class DeviceCapabilities(_message.Message):
    ...
    def __init__(self, isAdvertising: bool = ..., capableComponents: _Optional[int] = ...,
                 trackableComponents: _Optional[int] = ...) -> None: ...
...
class DeviceDescription(_message.Message):
    ...
    def __init__(self, userDefinedName: _Optional[str] = ..., deviceType: _Optional[_Union[SpotDeviceType, str]] = ...,
                 deviceComponentsInformation: _Optional[
                     _Iterable[_Union[DeviceComponentInformation, _Mapping]]] = ...) -> None: ...
