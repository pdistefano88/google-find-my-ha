...
def create_action_request(canonic_device_id: str,
                          ...
                          fmd_client_uuid: str=client_id) -> DeviceUpdate_pb2.ExecuteActionRequest:
...
def serialize_action_request(actionRequest: DeviceUpdate_pb2.ExecuteActionRequest) -> str:
