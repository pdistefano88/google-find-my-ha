...
from google_find_my_ha.Auth.adm_token_retrieval import get_adm_token
from google_find_my_ha.Auth.username_provider import get_username


def nova_request(api_scope, hex_payload) -> str:
    ...
    if response.status_code == 200:
        ...
        raise ValueError("[NovaRequest] Error: ", soup.get_text())
