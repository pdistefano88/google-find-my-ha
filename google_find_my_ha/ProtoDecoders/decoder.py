...
from google_find_my_ha.ProtoDecoders import DeviceUpdate_pb2, LocationReportsUpload_pb2
...
def parse_device_list_protobuf(hex_string: str) -> DeviceUpdate_pb2.DevicesList:
